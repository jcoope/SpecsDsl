 ...
 * </p>
 * <ul>
 *   <li>{@link com.example.library.impl.MemoryImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryImpl extends NamedElementImpl implements Memory {
	...
	protected EClass eStaticClass() {
		return LibraryPackage.Literals.MEMORY;
	}
	...
	public void setCapacity(int newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.MEMORY__CAPACITY, oldCapacity,
					capacity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case LibraryPackage.MEMORY__CAPACITY:
			return getCapacity();
		}
